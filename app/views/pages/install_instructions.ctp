...
<p><div class="notewarning"><strong>This method will not work on a fresh install <i>unless</i> you have updated your sources list first!</strong></div></p>
</div>
...
<p class="containingbox">Once you have downloaded the .bod file you want (make sure you note where you downloaded it to), there are 2 options for installation:&nbsp;&nbsp; <a href="#gui_install">Graphical</a> or <a href="#cli_install">Command Line.</a> </p>
</div>
...
<p>Open a Terminal and <code>cd</code> to the directory where the file was downloaded. Next change the file permissions to allow execution, type: </p>
<pre class="code"> 
 chmod 755 midori.bod 
