...
<div class="notewarning"><strong>This method will not work on a fresh install <em>unless</em> you have updated your sources list first!</strong></div>
</div>
...
<p class="containingbox">Click the <strong>Download Button</strong> on the page of the application you wish to install and downloaded the <abbr title="Bodhi's Offline Installer">.bod</abbr> file making sure you note where you downloaded it to. There are different options for installating this .bod file:&nbsp;&nbsp; <a href="#gui_install">Graphical</a> or <a href="#cli_install">Command Line.</a> </p>
</div>

<h3><a id="gui_install">Graphical Install</a></h3>
<br />
<div>
	
<div>
<img src="/img/gui_install1.png" class="floatright"   alt="" width="300" />
<p class="containingbox">Open <strong><abbr title="Enlightenment File Manager">EFM</abbr></strong> (the default file manager in <strong>Bodhi Linux</strong>) and navigate to the directory where you downloaded the file, in this example <em>ephoto.bod</em> for the <strong>ePhoto</strong> image viewer.</p><p class="containingbox"><em>Right-click</em> on the file and choose <em>File Properties.</em></p>
</div>
...
<div class="noteclassic"><strong>NOTE:</strong> You may need to restart <em>Enlightenment</em> before the application shows up in your menu.</div>
</div>

<h3><a id="cli_install">CLI Install</a></h3>
<br />
<div>
