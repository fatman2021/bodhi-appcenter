 ...
 */
	function display() {
		...
		$softBundle = $this->Softbundle->find('all',array('fields' => array('Softbundle.bundleName','Softbundle.id','Softbundle.bundleShrtDesc', 'Softbundle.md5', 'Softbundle.softSize', 'Softbundle.arch')));
		$softPackages = $this->Software->find('all',array('conditions'=>"Software.softCat='Software_Packages'",'fields' => array('Software.softName','Software.softCat', 'Software.arch')));
